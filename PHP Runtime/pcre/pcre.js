...
import {array} from "../standard/_types";
import {array_push} from "../standard/standard_8";
 ...
 */
export function preg_match (pattern, subject:string) {
    const regExp = new RegExp(pattern);
    const array = array();
    array_push(array,subject.match(regExp));
    return array
