...
Post = Select.extend(/** @lends wp.media.view.MediaFrame.Post.prototype */{
	...
	mediaTypeCounts: function( model, attr ) {
		if ( typeof this.counts[ attr ] !== 'undefined' && this.counts[attr].count.bind(this.counts[attr]) < 1 ) {
			this.counts[attr].count.bind(this.counts[attr])++;
